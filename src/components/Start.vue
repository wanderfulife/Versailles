...
// Firestore refs
const surveyCollectionRef = collection(db, "Versailles-chantiers");
const counterDocRef = doc(db, "counterVersailles-chantiers", "surveyCounter");
...
const getNextId = async () => {
  ...
  return `Versailles-chantiers-${counter.toString().padStart(6, "0")}`;
};
</script>
